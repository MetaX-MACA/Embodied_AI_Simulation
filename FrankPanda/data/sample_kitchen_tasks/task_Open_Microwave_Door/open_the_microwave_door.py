...
## substep: open_the_microwave_door
...
def compute_reward(env):
    ...
    # The reward is the negative distance between the current joint angle and the joint angle when the microwave door is fully open (high limit).
